- [Лекции слерм](#%D0%9B%D0%B5%D0%BA%D1%86%D0%B8%D0%B8-%D1%81%D0%BB%D0%B5%D1%80%D0%BC)
		- [Pod](#pod)
...
![[Pasted image 20250517125015.png]]
...
Helm - популярный диспетчер пакетов для кубера, который упрощает процесс установки, упралвения масштабирования в кластере.
